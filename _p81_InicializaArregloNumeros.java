// Inicaliza de forma manual arreglo de numeros flotantes y lo imprimes 
...
public class _p81_InicializaArregloNumeros {
    public static void main(String[] args) {
        ...
        System.out.printf("Primer elementp de arreglo %.2f\n", nums[0] );
        System.out.printf("Eltimo elemento del arreglo %.2f\n",nums[6] );
