// Genera dos arreglos de numeros aleatorios y los suma en un tercer arreglo 

import java.util.Random;

public class _p89_ArreglosAleatrios {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("El arreglo ya con aleatorios generados :<'n");
        GeneraAleatorio(A);
        GeneraAleatorio(B);
        Mostrar(A);
        Mostrar(B);
